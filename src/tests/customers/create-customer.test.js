...
const testKey = "create-customer";

describe('/customer create endpoint', () => {
    let createdAdmin;
    let jwtToken;
    ...
    it('should create a customer with the valid data', async() => {
        ...
        let createdCustomer = response.body.data;
